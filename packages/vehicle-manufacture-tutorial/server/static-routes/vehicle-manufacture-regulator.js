...
module.exports = function (app) {
    app.use('/regulator', express.static(path.join(__dirname, '../../../vehicle-manufacture-vda', 'client')));

    app.use('/regulator/less/stylesheets/*', function (req, res, next) {
        var url = req.originalUrl;
        var relativePath = url.replace('regulator/less/stylesheets/', '');
        var lessCSSFile = path.join('../../../vehicle-manufacture-vda/client', relativePath);
        req.url = lessCSSFile;
