...
module.exports = function (app) {   
    app.use('/manufacturer', express.static(path.join(__dirname, '../../../vehicle-manufacture-manufacturing', 'client')));
    ...
    app.use('/manufacturer/less/stylesheets/*', function (req, res, next) {
        ...
        var lessCSSFile = path.join('../../../vehicle-manufacture-manufacturing/client', relativePath);
        req.url = lessCSSFile;
